...
CAPABILITY_IAM. Deploy only after administrator review and verification of the
exact immutable container image. Generate the template from the checked-in proxy
